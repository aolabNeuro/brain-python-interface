...
class TestFactoryFunction(unittest.TestCase):
    ...
    @patch('riglib.optitrack_client_update_natnet.optitrack_client_updated.create_client')
    ...
    def test_factory_fallback_to_simulation(self):
        ...
        with patch('riglib.optitrack_client_update_natnet.optitrack_client_updated.create_client', side_effect=ImportError):
...
if __name__ == '__main__':
    ...
    for test_class in test_classes:
        if hasattr(test_class, '__bases__') and unittest.TestCase in test_class.__bases__:
            tests = unittest.TestLoader().loadTestsFromTestCase(test_class)
            suite.addTests(tests)
        else:
            print(f"Skipping {test_class}: Not a valid unittest.TestCase subclass")
