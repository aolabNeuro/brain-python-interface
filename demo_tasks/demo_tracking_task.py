...
from demo_tasks.demo_features import MouseControl, ProgressBar, ScoreRewards, SpheresToImages
    ...
    def launch_demo(self, name: str) -> None:
        ...
        try:
            if getattr(sys, "frozen", False):
                ...
                cmd = [sys.executable, "-m", "demo_tasks.demo_tracking_task", "--demo", name]
