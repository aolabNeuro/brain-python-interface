...
class EyeHandCaptureBlock(Sequence, Window):
    ...
    init_eye_target_alpha = traits.Float(0.75, desc="Transparency of the initial eye target")
    init_hand_target_alpha = traits.Float(0.75, desc="Transparency of the initial hand target")
    goal_target_alpha = traits.Float(0.75, desc="Transparency of the goal target")
