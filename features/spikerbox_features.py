...
class SpikerBoxBMI(CorticalBMI):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.cortical_channels = [1,2]
        spikerbox.EMG.subj = self.subject_name
        spikerbox.EMG.saveid = self.saveid
        ...
        self._neural_src_system_type = spikerbox.EMG
    ...
    def cleanup(self, database, saveid, **kwargs):
        ...
        filename = f'/var/tmp/tmp_{str(spikerbox.EMG)}_{self.subject_name}_{saveid}.hdf'
